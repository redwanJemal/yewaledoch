...
const translations: Record<Language, Record<string, string>> = {
  am: {
    ...
    'profile.role.mom': 'እናት',
    'profile.role.dad': 'አባት',
    ...
    'write.locked_subtitle': 'አስተያየት መስጠት ይጀምሩ! 5 አስተያየቶች ሲደርሱ ጽሑፍ ማጻፍ ይችላሉ',
  ...
  en: {
    ...
    'write.locked_subtitle': 'Start commenting! You can create posts after 5 comments',
